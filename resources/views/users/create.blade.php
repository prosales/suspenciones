    ...
    <div class="row">
        <div class="col-md-12">
            <div class="panel panel-default">
                <div class="panel-heading">Crear Usuario
                ...
                <div class="panel-body">
                    ...
                    <form class="form-horizontal" role="form" method="POST" action="{{ route('users.store') }}">
                        ...
                        <div class="form-group{{ $errors->has('movil') ? ' has-error' : '' }}">
                            <label for="movil" class="col-md-4 control-label">Es movil ?</label>
                            <div class="col-md-6">
                                <input id="movil" type="checkbox" class="form-control" name="movil" value="{{ old('movil') }}" required autofocus>
                                @if ($errors->has('movil'))
                                    <span class="help-block">
